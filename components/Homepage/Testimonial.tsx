...
const testimonial = [
  {
    ...
    Des: "CloudiDea Information Technology exceeded my expectations! They transformed our onsite Data Center into a captivating cloud presence that perfectly meets our requirements. Their expertise and professionalism was outstanding!",
  ...
  },
  {
    ...
    tImg: tImg2,
    Title: "Amazing software services",
    Des: "Working with this CloudiDea was a game-changer for my business. They migrated our aged MS Exchange Server to cloud environment. Thus enabling us to take advantage of a whole lot of associated cloud applications like MS Teams and Office365. I highly recommend their services!",
    Name: "Hana Molvoka",
    sub: "CEO, ZZ Agency",
    country: "Seattle, Ukraine",
  },
      ...
      <div className="row">
        <div className="col-lg-4">
          ...
          <h3 className="title_text">
              <mark>365+</mark> customers win deals with CloudZone IT
            </h3>
          </div>
        </div>
